...
public class FraudDetectionService {
    ...
    @Value("${fraud.max-balance-precentage}")
    private  double maxBalancePercentage;


    private static final VERIFICATION_REQUIRED_TOPIC = "verification.required";
    private static final FRAUD_CHECK_CLEAN_RESULT_TOPIC = "fraud.check.clean";
    ...
    private boolean isAccountSuspicious(String accountNumber, BigDecimal amount){
        ...
        BigDecimal avdAmount = new BigDecimal(avgStr);
